...
**Example:**  
**Input:** `encodeString("neogcamp", 2)` ––> **Output:** `pgqiecor` Explanation: 2 represents shifting alphabets by 2 places. a –> c, b –> d, c –> e and so on. 
...
**Input:** `toSentenceCase('we are neoGrammers')` ––> **Output:** `We Are NeoGrammers`
    ...
    console.log(capWord("we are neoGrammers"))
